...
exports.WandbViewerPanel = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
const fs = __importStar(require("fs"));
class WandbViewerPanel {
    ...
    static createOrShow(extensionUri, runData, logMetrics, runDir, outputLogPath) {
        ...
        const panel = vscode.window.createWebviewPanel('wandbViewer', `W&B: ${runData.runId}`, column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    _update(runData, logMetrics, runDir, outputLogPath) {
    ...
    _getHtmlContent(runData, logMetrics, runDir, outputLogPath) {
